...
const gamesContent = {
  en: {
    sectionTitle: 'Petra.bet Elite Live Casino',
    expertReview: {
      title: 'Professional Assessment',
      text: 'Petra.bet stands as Jordan\'s premier live casino destination for 2025, delivering unmatched bonuses, lightning-fast withdrawals, and a sophisticated gaming experience. While competitors like Betway and Rabona offer solid alternatives, Petra.bet\'s exclusive game selection, superior bonus structure, and VIP program make it the definitive choice for discerning players. For optimal winning potential, maximum security, and exceptional customer service, Petra.bet represents the pinnacle of online gaming excellence.'
    },
    userReviews: [
      { name: 'Mohammad Alali', rating: 5, text: 'Premium casino experience! Swift payouts and outstanding support.' },
      { name: 'Laila Hamdan', rating: 5, text: 'Petra.bet rewards are exceptional and I love their exclusive game collection!' },
      { name: 'Sami Dajani', rating: 4, text: 'Excellent gaming variety and instant withdrawals. Highly recommend!' },
      { name: 'Sara Almasri', rating: 5, text: 'Mobile app is superb and support is always accessible.' },
      { name: 'Ahmad Alzoubi', rating: 5, text: 'Petra.bet is my go-to for live games. Outstanding VIP benefits!' }
    ]
  },
  ar: {
    sectionTitle: 'كازينو بيترا.بت النخبة المباشر',
    expertReview: {
      title: 'تقييم مهني',
      text: 'بيترا.بت يقف كوجهة الكازينو المباشر الأولى في الأردن لعام 2025، مقدماً مكافآت لا تضاهى وسحوبات سريعة كالبرق وتجربة لعب متطورة. بينما يقدم المنافسون مثل بيتواي ورابونا بدائل جيدة، إلا أن مجموعة الألعاب الحصرية في بيترا.بت وهيكل المكافآت المتفوق وبرنامج VIP يجعله الخيار الأمثل للاعبين المميزين. للحصول على أفضل إمكانات الفوز والحد الأقصى من الأمان وخدمة العملاء الاستثنائية، بيترا.بت يمثل قمة التميز في الألعاب عبر الإنترنت.'
    },
    userReviews: [
      { name: 'محمد العلي', rating: 5, text: 'تجربة كازينو متميزة! دفعات سريعة ودعم متميز.' },
      { name: 'ليلى حمدان', rating: 5, text: 'مكافآت بيترا.بت استثنائية وأحب مجموعة الألعاب الحصرية لديهم!' },
      { name: 'سامي الدجاني', rating: 4, text: 'تنوع ألعاب ممتاز وسحوبات فورية. أنصح بشدة!' },
      { name: 'سارة المصري', rating: 5, text: 'التطبيق المحمول رائع والدعم متاح دائماً.' },
      { name: 'أحمد الزعبي', rating: 5, text: 'بيترا.بت هو خياري الأول للألعاب المباشرة. مزايا VIP متميزة!' }
    ]
  }
};
...
const affiliateContent = {
  en: {
    sectionTitle: 'Elite Partnership with Petra.bet',
    description: 'Join our exclusive partnership program and earn substantial commissions for every player you refer. Benefit from lifetime earnings, weekly payouts, custom commission structures, and dedicated support in your preferred language.',
    steps: [
      { icon: '📝', title: 'Register', desc: 'Create your account and receive your unique referral link.' },
    ...
    advantages: [
      'Weekly payouts – receive payments every week, instantly',
      'Lifetime commission – continue earning as long as your referrals play',
      'Custom commission plans – tailored to your business needs',
      'Local currencies supported',
      '24/7 multi-language support'
    ],
    cta: 'Join Elite Partnership',
    ctaLink: 'https://petra.bet/affiliate'
  },
  ar: {
    sectionTitle: 'شراكة نخبة مع بيترا.بت',
    description: 'انضم إلى برنامج الشراكة الحصري واربح عمولات كبيرة عن كل لاعب تقوم بدعوته. استفد من الأرباح مدى الحياة والدفعات الأسبوعية وهياكل العمولة المخصصة والدعم المخصص بلغتك المفضلة.',
    steps: [
      { icon: '📝', title: 'سجل', desc: 'أنشئ حسابك واحصل على رابط الإحالة الفريد الخاص بك.' },
      { icon: '🔗', title: 'شارك', desc: 'شارك رابط الإحالة مع أصدقائك ومتابعيك.' },
      { icon: '💸', title: 'اربح', desc: 'اربح عمولة عن كل رهان يضعه من تدعوهم.' }
    ],
    advantages: [
      'دفعات أسبوعية – احصل على مدفوعات كل أسبوع فوراً',
      'عمولة مدى الحياة – استمر في الكسب طالما يلعب من دعوتهم',
      'خطط عمولة مخصصة – مصممة حسب احتياجات عملك',
      'دعم العملات المحلية',
      'دعم متعدد اللغات على مدار الساعة'
    ],
    cta: 'انضم للشراكة النخبة',
    ctaLink: 'https://petra.bet/affiliate'
  }
};
...
function renderGames() {
  ...
  if (expertReviewDiv) {
    expertReviewDiv.innerHTML = `
      <h3 style="color:#10b981; font-size:1.25rem; font-weight:800; margin-bottom:0.7rem;">${gamesContent[lang].expertReview.title}</h3>
      <p style="color:#d1fae5; font-size:1.13rem; line-height:1.8; margin:0; font-weight:700; letter-spacing:0.5px; text-shadow:0 2px 10px #10b981cc;">${gamesContent[lang].expertReview.text}</p>
    `;
  }
  ...
  if (userReviewsDiv) {
    userReviewsDiv.innerHTML = `
      <h4 style="color:#10b981; font-size:1.18rem; font-weight:900; margin-bottom:1.1rem; letter-spacing:1px; text-shadow:0 2px 10px #10b981cc;">${lang === 'ar' ? 'شهادات اللاعبين' : 'Player Testimonials'}</h4>
      <div style="display:flex;gap:2.2rem;flex-wrap:wrap;justify-content:center;">
        ${gamesContent[lang].userReviews.map(r => `
          <div class="user-review-card" style="background:linear-gradient(120deg,#0f172a 60%,#10b981 120%);border-radius:18px;padding:2.1rem 1.7rem;min-width:260px;max-width:340px;box-shadow:0 4px 24px #10b98133;display:flex;flex-direction:column;align-items:center;border:2.5px solid #10b981; margin-bottom:1.5rem;">
            <span style="font-weight:900;color:#d1fae5;font-size:1.18rem;letter-spacing:0.5px;">${maskName(r.name, lang)}</span>
            <span style="color:#10b981;font-size:1.25rem;font-weight:900;">${'★'.repeat(r.rating)}${r.rating < 5 ? '☆' : ''}</span>
            <span style="font-size:1.09rem;color:#d1fae5;margin-top:0.7rem;text-align:center;font-weight:700;letter-spacing:0.2px;">${r.text}</span>
          </div>
        `).join('')}
      </div>
    `;
...
function showLuxuryPopup() {
  ...
  if (lang === 'ar') {
    msg.textContent = 'ما زلنا نجمع المعلومات حول هذا الكازينو. يرجى المراجعة لاحقاً! في هذه الأثناء، بيترا.بت هو خيارك الأفضل دائماً لتجربة ألعاب فاخرة.';
    btn.textContent = 'استمر مع بيترا.بت';
  } else {
    msg.textContent = 'We are still compiling information about this casino. Please check back soon! Meanwhile, Petra.bet remains your optimal choice for luxury gaming experiences.';
